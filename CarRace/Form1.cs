...
namespace CarRace {
    public partial class Form1 : Form {
        ...
        private void SetupRaceTrack() {
            ...
            Racers[0] = pFactory.getRacer("Player1",MaximumBet,p1Bet); //getting Jhon object from factory class
            Racers[1] = pFactory.getRacer("Player2", MaximumBet, p2Bet); //getting Mark object from factory class
            Racers[2] = pFactory.getRacer("Player3", MaximumBet, p3Bet); //getting Lim object from factory class
